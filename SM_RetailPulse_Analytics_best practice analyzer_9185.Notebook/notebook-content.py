...
dataset = "SM_RetailPulse_Analytics" # Enter the name or ID of the semantic model
workspace = "RetailPulse_CDC_Analytics_Dev" # Enter the workspace name or ID in which the semantic model exists
